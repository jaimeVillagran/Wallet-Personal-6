                ...
                <div class="col-md-6">
                    ...
                    <h2 class="text-center mt-5">Panel de Transacciones</h2>
                     <p class="text-center mt-5">Selecciona una opción para gestionar tus fondos.</p>
                        <div class="row justify-content-center">
                            <a href="<c:url value='/deposit' />" class="btn btn-primary">Depositar</a>
                            <a href="<c:url value='/withdraw' />" class="btn btn-secondary ms-2">Retirar</a>
                            <a href="<c:url value='/transfer' />" class="btn btn-success ms-2">Transferir</a>
                            <a href="<c:url value='/transaction?user_id=${user.userId}' />" class="btn btn-info ms-2">Ver Saldo</a>
                            <a href="<c:url value='/logout' />" class="btn btn-danger ms-2">Cerrar Sesión</a>
